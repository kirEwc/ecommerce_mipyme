...
export const Home_Main_Content = () => {
  ...
  const products = [
    ...
    { id: 2, name: "Blusa de encaje", price: 15.99, image: "/images/product/website-development.webp" },
    { id: 3, name: "Jeans ajustados", price: 29.99, image: "/images/product/website-development.webp" },
    { id: 4, name: "Chaqueta de cuero", price: 49.99, image: "/images/product/website-development.webp" },
    { id: 5, name: "Falda plisada", price: 24.99, image: "/images/product/website-development.webp" },
    { id: 6, name: "Camiseta gráfica", price: 12.99, image: "/images/product/website-development.webp" },
    { id: 7, name: "Sudadera con capucha", price: 34.99, image: "/images/product/website-development.webp" },
    { id: 8, name: "Pantalones cargo", price: 39.99, image: "/images/product/website-development.webp" },
  ]
  return (
